...
// Sequence
offset.value = withSequence(withTiming(-10, { duration: 100 }), withTiming(10, { duration: 100 }), withSpring(0))
...
```tsx
import Animated, { useAnimatedScrollHandler, useSharedValue, interpolate, Extrapolation } from 'react-native-reanimated'
