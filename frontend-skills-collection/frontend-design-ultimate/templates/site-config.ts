    ...
    plans: [
      {
        ...
        features: ['500 suggestions/month', 'Browser extension', 'Basic style learning'],
        cta: { label: 'Get Started', href: '/signup' },
      },
      {
        name: 'Pro',
      ...
      },
      {
        ...
        features: ['Everything in Pro', 'Team style sharing', 'Admin dashboard', 'SSO & SAML', 'Dedicated support'],
    ...
    items: [
      {
        ...
        answer:
          'Our AI analyzes your writing patterns, vocabulary choices, and tone preferences. The more you write, the better it understands your unique voice. All learning happens locally and your data is never shared.',
      },
      {
        question: 'Is there a free trial?',
        answer:
          'Yes! You can try Pro features free for 14 days, no credit card required. After that, you can continue on our free plan or upgrade to Pro.',
      },
      {
        question: 'Can I cancel anytime?',
        answer:
          'Absolutely. No contracts, no cancellation fees. You can cancel your subscription at any time from your account settings.',
      },
      {
      ...
      },
      {
        ...
        answer:
          '100%. We use end-to-end encryption, never sell your data, and never train our models on your personal content. Your writing stays yours.',
      },
    ],
  },
